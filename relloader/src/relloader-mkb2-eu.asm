# 80006edc - Address to hook for this code
...
ori r3,r30,0x8304 # CARDMountAsync
mtctr r3
li r3,0 # Memory Card Slot A
...
# Read from the Card
ori r3,r30,0x9808 # CARDReadAsync
mtctr r3
...
# Flush the memory
ori r3,r28,0xde80 # DCFlushRange
mtctr r3
mr r3,r30 # Dest
mr r4,r31 # Size
bctrl
...
ori r4,r28,0xdb60 # OSAllocFromArenaLow
mtctr r4
addi r3,r3,31
...
ori r3,r30,0x4f08 # CARDGetResultCode
mtctr r3
li r3,0 # Memory Card Slot A
bctrl
cmpwi r3,-1 # CARD_RESULT_BUSY
...
ori r3,r30,0x4dec # __CARDGetControlBlock
mtctr r3
addi r4,sp,0xc
lwz r3,0(r31)
bctrl
...
noProblemsFound:
ori r3,r30,0x4ea4 # __CARDPutControlBlock
mtctr r3
li r0,-1
stw r0,0(r31)
li r4,0

    ...
    if (show_second_argument == true) {
        if (hours_1 > 0) {
            if (hours_2 > 0) {
                ...
                draw::debug_text(a, b, color, "%s%d:%02d:%02d.%02d (%s%d:%02d:%02d.%02d)", sign,
                                 hours_1, minutes_1, seconds_1, centiseconds_1, sign, hours_2,
                                 minutes_2, seconds_2, centiseconds_2);
            } else if (minutes_2 > 0) {
                draw::debug_text(A, b, color, prefix);
                draw::debug_text(a, b, color, "%s%d:%02d:%02d.%02d (%s%02d:%02d.%02d)", sign,
                                 hours_1, minutes_1, seconds_1, centiseconds_1, sign, minutes_2,
                                 seconds_2, centiseconds_2);
            } else {
                draw::debug_text(A, b, color, prefix);
                draw::debug_text(a, b, color, "%s%d:%02d:%02d.%02d (%s%02d.%02d)", sign, hours_1,
            ...
            if (hours_2 > 0) {
                draw::debug_text(A, b, color, prefix);
                draw::debug_text(a, b, color, "%s%02d:%02d.%02d (%s%d:%02d:%02d.%02d)", sign,
                                 minutes_1, seconds_1, centiseconds_1, sign, hours_2, minutes_2,
                                 seconds_2, centiseconds_2);
            } else if (minutes_2 > 0) {
                draw::debug_text(A, b, color, prefix);
                draw::debug_text(a, b, color, "%s%02d:%02d.%02d (%s%02d:%02d.%02d)", sign,
                                 minutes_1, seconds_1, centiseconds_1, sign, minutes_2, seconds_2,
                                 centiseconds_2);
            } else {
                draw::debug_text(A, b, color, prefix);
                draw::debug_text(a, b, color, "%s%02d:%02d.%02d (%s%02d.%02d)", sign, minutes_1,
        ...
        if (hours_1 > 0 && !show_seconds_only) {
            draw::debug_text(A, b, color, prefix);
            draw::debug_text(a, b, color, "%s%d:%02d:%02d.%02d", sign, hours_1, minutes_1,
                             seconds_1, centiseconds_1);

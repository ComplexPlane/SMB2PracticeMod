...
TRAMP(s_ready_init_tramp, mkb::smd_game_ready_init, []() {
    ActiveMode next_mode = ActiveMode(pref::get(pref::Pref::StageEditVariant));
...
TRAMP(s_load_stagedef_tramp, mkb::load_stagedef, [](u32 stage_id) {

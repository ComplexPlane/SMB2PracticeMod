...
struct MKB(Item) { /* Represents an item that can be picked up by the player. These are bananas in main game, but can be other pickups in the party games. Are "tickable" like events, effects, etc. */
    ...
    struct MKB(GmaModel) * model_ptr;
    float field27_0x6c;
    MKB(s16) negative_y_rotation;
    ...
    MKB(u32) g_some_flag_2;
    struct MKB(Vec) shadow_position;
    struct MKB(Vec) g_something_with_shadows;
} __attribute__((__packed__));
...
extern "C" {
    ...
    extern undefined4 MKB(g_smth_with_widescreen);
    extern undefined2 MKB(g_global_widescreen_translation_x);
    ...
    extern undefined1 MKB(g_haze_type);
    ...
    void MKB(g_something_with_view_stage)(void);
    ...
    void MKB(g_something_with_view_stage_and_ball)(void);
    ...
    void MKB(g_smth_with_viewstage_and_whs)(void);
    ...
    void MKB(g_something_with_view_stage_and_bg)(void);
    ...
    void MKB(g_something_with_view_stage_and_item)(void);
    ...
    void MKB(g_scale_sprite_for_widescreen)(uint param_1);
    void MKB(g_reset_sprite_mtx_for_widescreen)(void);
    ...
    void MKB(g_some_cleanup_func)(undefined1 param_1, undefined1 param_2, undefined1 param_3);

    ...
    switch (selected->type) {
        ...
        case WidgetType_InputSelect: {
            ...
            if (s_binding == BindingState_Requested &&
                pad_button_released(mkb_PAD_BUTTON_A, true)) {
...
static f32 sin_lerp(s32 period_frames) {
    f32 angle = ((s32)(s_cursor_frame % period_frames) - (period_frames / 2.f)) *
...
static void draw_widget(Widget * widget, u32 selected_idx, u32* selectable_idx, u32* y,
    ...
    switch (widget->type) {
        ...
        case WidgetType_ColoredText: {
            draw_debug_text(MARGIN + PAD, *y, widget->colored_text.color,
        ...
        case WidgetType_InputSelect: {
            ...
            if (s_binding == BindingState_Active && selected_idx == *selectable_idx) {
                draw_debug_text(MARGIN + PAD, *y, FOCUSED_COLOR, "  %s",

...
void disp()
{
    ...
    draw::debugText(MARGIN + PAD, MARGIN + PAD + 13 * LINE_HEIGHT, draw::Color::WHITE, "  For the newest version of the practice mod:");
    draw::debugText(MARGIN + PAD, MARGIN + PAD + 14 * LINE_HEIGHT, draw::Color::BLUE, "  github.com/ComplexPlane/ApeSphere/releases");
}
